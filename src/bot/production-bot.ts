  ...
  switch (data) {
    ...
    case (data.startsWith('regenerate_image_') ? data : null): {
      ...
      if (modelInfo) {
        ...
        // Если модель не найдена, просто открываем меню выбора модели
        UXHelpers.setUserState(userId, {
          currentAction: 'waiting_image_prompt',
